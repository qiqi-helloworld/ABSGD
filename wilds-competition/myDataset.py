...
from wilds.datasets.unlabeled.wilds_unlabeled_dataset import WILDSDataset
...
class myIWildCamDataset(WILDSDataset):
    """
    ...
    def __init__(self, version=None, root_dir='/dual_data/not_backed_up/', download=False, split_scheme='official'):
...
def get_dataset(dataset: str, version: Optional[str] = None, unlabeled: bool = False, **dataset_kwargs):
    ...
    if dataset == 'iwildcam':
        return myIWildCamDataset(version=version, **dataset_kwargs)